...
<div class="bg-overlay-black-60 parallax" style="background-image: url(images/pass2.png);">
  ...
  <div class="container">
     <div class="row justify-content-center">
       ...
       <div class="logo text-center mb-30 mt-30">
           <a href="https://www.orangeblossomlogistics.com"><img class="logo-small" id="logo_img" src="images/about/transparentlogo.png" alt="logo"> </a>
         </div>
             ...
             <div class="login-form">
               <div class="section-field mb-20">
                ...
                <div class="section-field">
                 ...
                 <p class="mt-20 mb-0">Don't have an account? <a href="https://www.orangeblossomlogistics.com/signup"> Create one here</a></p>
               </div>
              <div class="login-social text-center clearfix">
                <h4 class="theme-color mb-20"><a href="https://www.orangeblossomlogistics.com">← Return Home</h4>
              </div>
           </div>
        </div>
      </div>
