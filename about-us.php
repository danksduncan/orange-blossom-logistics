...
<title>About Us - Orange Blossom Logistics</title>
...
<section class="page-title center light-overlay parallax" data-jarallax='{"speed": 0.6}' style="background-image: url(images/interstate.png);">
  <div class="container">
    <div class="row"> 
      <div class="col-lg-12 pt-140">
         <div class="slider-content text-center">
           <!-- <h1 class="text-uppercase text-black"> <b>About </b> Us</h1> -->
          </div>
     </div>
     </div>
  </div>
     ...
     <div class="row">
      <div class="col-lg-6">
        <div class="section-title">
            <h1 class="text-uppercase text-black" style="text-align: center; margin-bottom: 45px;"> <b>About </b> Us</h1>
            <p style="text-align: center">Founded and established in Central Florida, our team is here to help you with all your logistics needs. We offer services in general freight transportation as well as specialized commodity and equipment types. We are able to provide competitive industry rates combined with priority service for your freight. Come join us and let's get moving!</p>
          </div> 
      </div> 
      <div class="col-lg-6">
         ...
         <div class="owl-carousel" data-nav-dots="true" data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
          <div class="item"><img class="img-fluid full-width" src="images/pass2.png" alt="">
          </div>
         </div>
        </div>
      </div>
